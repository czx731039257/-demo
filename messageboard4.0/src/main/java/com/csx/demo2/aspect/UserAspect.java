...
public class UserAspect {
     ...
     * @throws Throwable
     */
    @Around("execution(* com.csx.demo2.controller.UserController.*(..))&&!execution(* com.csx.demo2.controller.UserController.EditUserInfoController(..))&&!execution(* com.csx.demo2.controller.UserController.CancelUserController(..))")
    public Object Log_User(ProceedingJoinPoint joinPoint) throws Throwable {
