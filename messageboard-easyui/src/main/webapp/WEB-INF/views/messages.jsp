    ...
    <div region="center" border="false" style="height: 100%">
        <div class="easyui-layout" fit="true">
                    ...
                    <div title="留言管理" style="height: 100%" closable="true">
                        ...
                        <div id="toolbar">
                            <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
                               onclick="newMessage()">新建留言</a>
                            <a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true"
                               onclick="editMessage()">编辑留言</a>
                            <a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true"
                               onclick="removeMessage()">删除留言</a>
            ...
            <div region="west" border="true" class="p-left" style="width: 20%">
                <div id="sm" class="easyui-sidemenu" data-options="data:data"
                     style="width: 100%;height: max-content"></div>
